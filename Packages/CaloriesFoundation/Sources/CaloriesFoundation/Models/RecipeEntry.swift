...
@Model public class RecipeEntry {
    ...
    public var dishPhotoData: Data?
    public var stepsPhotoData: Data?
    public var caloriesPerPortion: Int = 0
    public var suggestions: String = ""
    public var pageNumber: Int?
    public var rating: Int16 = 0
    @Relationship public var categories: [CategoryEntry] = []
    @Relationship public var book: BookEntry?

    public var breakfastSuitability: MealSuitability {
        get { MealSuitability(rawValue: breakfastSuitabilityRaw) ?? .never }
        set { breakfastSuitabilityRaw = newValue.rawValue }
    }

    public var lunchSuitability: MealSuitability {
        get { MealSuitability(rawValue: lunchSuitabilityRaw) ?? .never }
        set { lunchSuitabilityRaw = newValue.rawValue }
    }

    public var dinnerSuitability: MealSuitability {
...
extension RecipeEntry: Equatable {
    ...
    static public func seedRecipes(into modelContext: ModelContext) {
